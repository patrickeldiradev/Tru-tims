...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-rotate-left"></i> Receive Payment
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                              ...
                              <form class="form-bordered" method="post" action="/accounts/receivepayment">
                                  <div class="row">
                                	...
                                	<div class="form-group col-md-4">
                                		...
                                		<input type="text" class="form-control" name="transaction_date" value="<?=date("Y-m-d H:i:s")?>" required>
                                	</div>
                    ...
                    <!--<a class="btn btn-success" data-toggle="modal" data-target="#pay_transporter_modal"><i class="fa fa-glass"></i> Receive Payment from Transporter</a>-->
                    <!-- Modal -->
