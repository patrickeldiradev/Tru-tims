            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body table-responsive padding">   
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <form class="form-bordered" method="post" action="/reports/filtervoucherstatements">
                                <div class="row">
                    ...
                    <hr>    
                    <iframe width="100%" height="500px" src="/reports/filteredvoucherstatementspdf?start_date=<?=$startdate;?>&end_date=<?=$enddate;?>"></iframe>
