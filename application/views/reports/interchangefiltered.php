<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-exchange"></i> Interchange Report 
        <small></small>
      </h1>
      <hr>
    </section>
              ...
              <div class="box">
                <div class="box-body table-responsive padding">   
                    <div class="box-header">
                        <h3 class="box-title">Interchange Report</h3>
                    </div>      
                           
                    <div class="form-group">
                        <div class="col-md-12">
                            <form class="form-bordered" method="post" action="/reports/filterinterchange">
                                <div class="row">
                    ...
                    <hr>            
                    <!--filterdailyreports-->
                    <iframe width="100%" height="500px" src="/reports/filteredinterchangepdf?start=<?=$startdate?>&end=<?=$enddate?>"></iframe>
