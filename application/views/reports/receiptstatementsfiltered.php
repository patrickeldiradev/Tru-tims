<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-circle-o"></i> Transaction Receipts 
        <small></small>
      </h1>
      <hr>
    </section>
              ...
              <div class="box">
                <div class="box-body table-responsive padding">   
                    <div class="box-header">
                        <h3 class="box-title">Transaction Receipts </h3>
                    </div>      
                           
                    <div class="form-group">
                        <div class="col-md-12">
                            <form class="form-bordered" method="post" action="/reports/filterreceiptstatements">
                                <div class="row">
                                    <!--div class="col-md-4">
                                        <label>Client</label>
                    ...
                    <hr>
                    <iframe width="100%" height="500px" src="/reports/filteredreceiptstatementspdf?start_date=<?=$startdate;?>&end_date=<?=$enddate;?>"></iframe> 
