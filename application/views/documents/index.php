                                    ...
                                    <td align="left">
                                        <form method="post"  action="/documents/deletedoc?id=<?=$c->id?>">
                                            ...
                                            <p>
                                                ...
                                                <a href="/documents/statement?file_no=<?=$c->file_no;?>&container_nr=<?=$c->container_nr;?>">
                                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="tooltip" title="Statement" data-original-title="Statement">
