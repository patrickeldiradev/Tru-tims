                    ...
                    <div class="col-md-12">
                      ...
                      <div class="box box-primary">
                            ...
                            <?php $this->load->helper("form"); ?>
                              ...
                              <form style="padding: 5px;" class="form-bordered" method="post" action="/documents/payadvance?id=<?=$id?>"> 
                                  <div class="row">
                                	...
                                	<div class="form-group col-md-12">
                                		...
                                		<input type="text" class="form-control" name="container_nr" value="<?=$container_nr?>" readonly>
                                		<input type="hidden" class="form-control" name="file_no" value="<?=$file_no?>" required>
                                	</div>
                                  </div>
                       ...
                       <tbody>
                            <?php foreach($payments as $c){ ?>
                                <tr> 
                                    ...
                                    <td><?=$c->ref;?> </td>
                                    <td align="center">
                                        <form method="post" action="/documents/deleteadvance?id=<?=$c->id;?>&document_id=<?=$id?>">
                                            <input type="hidden" name="delid" value="<?=$c->id?>">
                                            <!--<a href="/documents/editadvance?id=<?=$c->id;?>&document_id=<?=$id?>">-->
