...
<html>
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Amey Trading : Forgot Password</title>
  ...
  <body class="login-page">
    <div class="login-box">
        <div class="login-logo">
            <img width="150" src="<?php echo base_url(); ?>assets/images/logo.jpg" class="img-circle" alt="Logo" />
        </div>
        <!-- /.login-logo -->
      ...
      <a style="font-size: 100%;font-weight: bolder;" href="http://wilcomkenya.co.ke"><b></b><br><b>Wilcom Cargo Management System </b>  | Version 2.2.0</a>
    </div><!-- /.login-box -->
